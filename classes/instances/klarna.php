...
class WC_UnzerDirect_Klarna extends WC_UnzerDirect_Instance {
	...
	public function __construct() {
		...
		$this->id = 'unzer_direct_klarna';

		$this->method_title = 'Unzer Direct Klarna';
	...
	public function init_form_fields() {
		$this->form_fields = [
			...
			'description' => [
				...
				'default'     => __( 'Pay with Klarna Invoice, Klarna Direct Debit or Klarna Instalments', 'wc-unzer-direct' )
			],
		];
	}
